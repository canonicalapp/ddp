...
export class Utils {
   ...
   */
  static generateBackupName(originalName, suffix = 'dropped') {
   ...
   */
  static generateOutputFilename(devSchema, prodSchema, prefix = 'schema-sync') {
   ...
   * @param {Object} column - Column object with properties
   * @returns {string} Formatted column definition
   */
  static formatColumnDefinition(column) {
   ...
   */
  static generateManualReviewComment(type, name, reason) {
   ...
   */
  static generateSectionHeader(title) {
    return [
      '-- ===========================================',
      `-- ${title.toUpperCase()}`,
      '-- ===========================================',
